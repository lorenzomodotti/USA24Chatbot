...
class Copilot:
    def __init__(self, key):
        ...
        self.system_prompt = """
            You are an expert about the political platforms of the Democratic Party and the Republican Party for the 2024 US presidential election. Your job is to answer questions 
            related to the opinions, viewpoints or goals of the two parties.
        """
    ...
    def ask(self, question, messages):
        ...
        processed_query_prompt = """
            ...
            Please answer the question based on the retrieved information. If the question is not related to the political platforms of the Democratic Party and Republican Party for the 2024 US presidential election,
            please inform the user and ask for a question related to the political platforms of the Democratic Party and Republican Party for the 2024 US presidential election.

            Please highlight the information with bold text and bullet points. Please clarify whose view, opinion or goal you are presenting. 
        """
